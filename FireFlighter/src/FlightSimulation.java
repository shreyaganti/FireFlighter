...
public class FlightSimulation
{
	...
	public void draw(PApplet drawer)
	{
		...
		{
			JOptionPane.showMessageDialog(null, "GAME OVER -- UNSUCCESSFUL TAKEOFF", "GAME OVER", JOptionPane.INFORMATION_MESSAGE);
			System.exit(0);
		}
		...
		double distanceLeft = (scenery.getNumImages()-1)*700 - plane.getTrueX() - plane.getWidth();
